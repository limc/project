...
tsnescatterplot(model, 'agreement', ['cooperation', 'parties', 'international', 'Article', 'European', 'committee', 'organization', 'information'],'agreement_random')

tsnescatterplot(model, 'agreement', [i[0] for i in model.wv.most_similar(negative=["agreement"])], 'agreement_negative')
